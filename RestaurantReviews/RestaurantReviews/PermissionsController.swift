...
class PermissionsController: UIViewController {
    ...
    lazy var locationPermissionButton:  UIButton = {
        ...
        button.backgroundColor = UIColor(displayP3Red: 62/255.0, green: 71/255.0, blue: 79/255.0, alpha: 1.0)
        button.setTitleColor(UIColor(displayP3Red: 178/255.0, green: 187/255.0, blue: 185/255.0, alpha: 1.0), for: .disabled)
    ...
    override func viewDidLoad() {
        ...
        view.backgroundColor = UIColor(displayP3Red: 95/255.0, green: 207/255.0, blue: 128/255.0, alpha: 1.0)
    }
